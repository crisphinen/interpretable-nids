# training script for cbm variants on ctu-iot-23 and cic-iot-2023.
#
# usage:
...
# load and preprocess data for the given dataset name ('ctu' or 'cic').
...
# stage 2 of sequentialcbm: freeze encoder+concept_heads, train classifier.

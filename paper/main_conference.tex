...
open-set detectability. No property of the known-class representation we
examined---within-class variance, Fisher or LDA separability, or closed-set
accuracy---predicts it consistently, because detectability is governed by the

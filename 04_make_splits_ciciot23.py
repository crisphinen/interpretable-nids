# build cic-iot-2023 splits.
# uses duckdb cli for the database query, then pandas for splitting.
# produces: train / val / test_known / test_unknown parquet files + vocab.json
#
# usage: python 04_make_splits_ciciot23.py
